...
// init_timer_1 initializes Timer 1.
// It takes 2 parameters: PRESCALER, TOP COUNT VALUE
...
// init_pwm initializes PWM on one of the I/O pins.
// It takes in 1 parameter: PWM CONFIG STRUCTURE
...
// pwm_ref_val sets the new PWM period.
...
// stop_pwm stops the PWM.
void stop_pwm()
{
	pwm_flag = PWM_OFF;
}

// start_pwm start the PWM.
void start_pwm()
{
	pwm_flag = PWM_ON;
}
